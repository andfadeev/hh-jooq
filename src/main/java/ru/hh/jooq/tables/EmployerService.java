...
public class EmployerService extends TableImpl<EmployerServiceRecord> {
    ...
    private static final long serialVersionUID = -677869036;
    ...
    public List<ForeignKey<EmployerServiceRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<EmployerServiceRecord, ?>>asList(Keys.EMPLOYER_SERVICE__EMPLOYER_SERVICE_SERVICE_ID_FKEY, Keys.EMPLOYER_SERVICE__EMPLOYER_SERVICE_IBFK_1, Keys.EMPLOYER_SERVICE__FK_PAYER_ID, Keys.EMPLOYER_SERVICE__EMPLOYER_SERVICE_ORDER_FK, Keys.EMPLOYER_SERVICE__FKD1AD6931A760195F, Keys.EMPLOYER_SERVICE__EMPLOYER_SERVICE_CURRENCY);
    }
