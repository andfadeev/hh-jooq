...
public class Service extends TableImpl<ServiceRecord> {
    ...
    private static final long serialVersionUID = 419197047;
    ...
    public List<ForeignKey<ServiceRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ServiceRecord, ?>>asList(Keys.SERVICE__SERVICE_CURRENCY, Keys.SERVICE__SERVICE_BONUS_CURRENCY, Keys.SERVICE__SERVICE_PERIOD_CURRENCY, Keys.SERVICE__SERVICE_BONUS_SCORE_CURRENCY);
    }
