...
public class Deed extends TableImpl<DeedRecord> {
    ...
    private static final long serialVersionUID = -1864174681;
    ...
    public List<ForeignKey<DeedRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DeedRecord, ?>>asList(Keys.DEED__EMPLOYER_SERVICE_ID_FKEY, Keys.DEED__DEED_IBFK_1, Keys.DEED__DEED_BANK_DETAIL_ID_FKEY, Keys.DEED__BONUS_EMPLOYER_SERVICE_ID_FKEY, Keys.DEED__DEED_RECIPIENT_ID_FKEY, Keys.DEED__DEED_CURRENCY, Keys.DEED__DEED_FILE, Keys.DEED__DEED_ASPE_ID_FKEY, Keys.DEED__DEED_FILE_ID);
    }
