...
public class Bill extends TableImpl<BillRecord> {
    ...
    private static final long serialVersionUID = -1675803477;
    ...
    public List<ForeignKey<BillRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<BillRecord, ?>>asList(Keys.BILL__BILL_ACCOUNT_ID_FKEY, Keys.BILL__BILL_RECIPIENT_ID_FK, Keys.BILL__BILL_CURRENCY, Keys.BILL__BILL_BILLING_TEMPLATE_ID_FK);
    }
