...
public class GbtTsDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1969534421;
    ...
    /**
     * The parameter <code>public.gbt_ts_distance._1</code>.
     */
    ...
    public GbtTsDistance() {
        super("gbt_ts_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
