...
public class _IntDifferent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 863947412;

    /**
     * The parameter <code>public._int_different.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public._int_different._1</code>.
     */
    ...
    /**
     * The parameter <code>public._int_different._2</code>.
     */
     ...
     */
    public _IntDifferent() {
        super("_int_different", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
