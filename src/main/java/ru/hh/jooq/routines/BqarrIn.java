...
public class BqarrIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1540440558;

    /**
     * The parameter <code>public.bqarr_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.bqarr_in._1</code>.
     */
     ...
     */
    public BqarrIn() {
        super("bqarr_in", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
