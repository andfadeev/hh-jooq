...
public class GbtInetPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -2075728446;

    /**
     * The parameter <code>public.gbt_inet_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_inet_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_inet_picksplit._2</code>.
     */
    ...
    public GbtInetPicksplit() {
        super("gbt_inet_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
