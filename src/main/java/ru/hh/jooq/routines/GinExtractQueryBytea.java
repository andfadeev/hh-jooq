...
public class GinExtractQueryBytea extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -119768629;

    /**
     * The parameter <code>public.gin_extract_query_bytea.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bytea._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gin_extract_query_bytea._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bytea._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_bytea._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bytea._5</code>.
     */
    ...
    public GinExtractQueryBytea() {
        super("gin_extract_query_bytea", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
