...
public class GinExtractValueTimetz extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 2143660732;

    /**
     * The parameter <code>public.gin_extract_value_timetz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_timetz._1</code>.
     */
    public static final Parameter<LocalTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALTIME, false, true);

    /**
     * The parameter <code>public.gin_extract_value_timetz._2</code>.
     */
    ...
    public GinExtractValueTimetz() {
        super("gin_extract_value_timetz", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
