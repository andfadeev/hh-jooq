...
public class GinNumericCmp extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = -1579114979;

    /**
     * The parameter <code>public.gin_numeric_cmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.gin_numeric_cmp._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>public.gin_numeric_cmp._2</code>.
     */
    ...
    public GinNumericCmp() {
        super("gin_numeric_cmp", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
