...
public class GinExtractValueFloat8 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1975548699;

    /**
     * The parameter <code>public.gin_extract_value_float8.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_float8._1</code>.
     */
    public static final Parameter<Double> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DOUBLE, false, true);

    /**
     * The parameter <code>public.gin_extract_value_float8._2</code>.
     */
    ...
    public GinExtractValueFloat8() {
        super("gin_extract_value_float8", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
