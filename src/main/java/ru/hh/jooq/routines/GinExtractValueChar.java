...
public class GinExtractValueChar extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1877647638;

    /**
     * The parameter <code>public.gin_extract_value_char.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_char._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_value_char._2</code>.
     */
    ...
    public GinExtractValueChar() {
        super("gin_extract_value_char", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
