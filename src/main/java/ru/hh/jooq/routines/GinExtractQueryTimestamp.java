...
public class GinExtractQueryTimestamp extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -965387128;

    /**
     * The parameter <code>public.gin_extract_query_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamp._1</code>.
     */
    public static final Parameter<LocalDateTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATETIME, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timestamp._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamp._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timestamp._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamp._5</code>.
     */
    ...
    public GinExtractQueryTimestamp() {
        super("gin_extract_query_timestamp", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
