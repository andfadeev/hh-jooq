...
public class GinExtractValueFloat4 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1058432191;

    /**
     * The parameter <code>public.gin_extract_value_float4.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_float4._1</code>.
     */
    public static final Parameter<Float> _1 = createParameter("_1", org.jooq.impl.SQLDataType.REAL, false, true);

    /**
     * The parameter <code>public.gin_extract_value_float4._2</code>.
     */
    ...
    public GinExtractValueFloat4() {
        super("gin_extract_value_float4", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
