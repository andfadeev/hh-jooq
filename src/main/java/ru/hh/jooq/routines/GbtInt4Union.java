...
public class GbtInt4Union extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1881072254;

    /**
     * The parameter <code>public.gbt_int4_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt4Union() {
        super("gbt_int4_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
