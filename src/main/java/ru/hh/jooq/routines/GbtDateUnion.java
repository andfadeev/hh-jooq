...
public class GbtDateUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1326273424;

    /**
     * The parameter <code>public.gbt_date_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtDateUnion() {
        super("gbt_date_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
