...
public class SortAsc extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = -1308353464;

    /**
     * The parameter <code>public.sort_asc.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.sort_asc._1</code>.
     */
     ...
     */
    public SortAsc() {
        super("sort_asc", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
