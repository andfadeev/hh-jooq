...
public class GbtIntvConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 108900436;
    ...
    /**
     * The parameter <code>public.gbt_intv_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_intv_consistent._5</code>.
     */
    ...
    public GbtIntvConsistent() {
        super("gbt_intv_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
