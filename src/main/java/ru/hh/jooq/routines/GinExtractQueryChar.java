...
public class GinExtractQueryChar extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1253388;

    /**
     * The parameter <code>public.gin_extract_query_char.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_char._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_query_char._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_char._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_char._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_char._5</code>.
     */
    ...
    public GinExtractQueryChar() {
        super("gin_extract_query_char", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
