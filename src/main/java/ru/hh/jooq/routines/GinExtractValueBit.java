...
public class GinExtractValueBit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 368754966;

    /**
     * The parameter <code>public.gin_extract_value_bit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_bit._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_value_bit._2</code>.
     */
    ...
    public GinExtractValueBit() {
        super("gin_extract_value_bit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
