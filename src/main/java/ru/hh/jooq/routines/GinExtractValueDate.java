...
public class GinExtractValueDate extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -469874865;

    /**
     * The parameter <code>public.gin_extract_value_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_date._1</code>.
     */
    public static final Parameter<LocalDate> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATE, false, true);

    /**
     * The parameter <code>public.gin_extract_value_date._2</code>.
     */
    ...
    public GinExtractValueDate() {
        super("gin_extract_value_date", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
