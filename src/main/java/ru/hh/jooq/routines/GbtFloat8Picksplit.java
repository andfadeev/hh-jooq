...
public class GbtFloat8Picksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1140203890;

    /**
     * The parameter <code>public.gbt_float8_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float8_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float8_picksplit._2</code>.
     */
    ...
    public GbtFloat8Picksplit() {
        super("gbt_float8_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
