...
public class Intset extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = 1825742113;

    /**
     * The parameter <code>public.intset.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.intset._1</code>.
     */
     ...
     */
    public Intset() {
        super("intset", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
