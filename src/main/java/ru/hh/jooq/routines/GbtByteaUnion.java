...
public class GbtByteaUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -371055962;

    /**
     * The parameter <code>public.gbt_bytea_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bytea_union._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gbt_bytea_union._2</code>.
     */
    ...
    public GbtByteaUnion() {
        super("gbt_bytea_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
