...
public class Inserttranslation extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -664026981;

    /**
     * The parameter <code>public.inserttranslation._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.inserttranslation._2</code>.
     */
    ...
    public Inserttranslation() {
        super("inserttranslation", Public.PUBLIC);
