...
public class GbtInt8Picksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1670153112;

    /**
     * The parameter <code>public.gbt_int8_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_int8_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_int8_picksplit._2</code>.
     */
    ...
    public GbtInt8Picksplit() {
        super("gbt_int8_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
