...
public class GinExtractQueryTime extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 2045051431;

    /**
     * The parameter <code>public.gin_extract_query_time.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_time._1</code>.
     */
    public static final Parameter<LocalTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALTIME, false, true);

    /**
     * The parameter <code>public.gin_extract_query_time._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_time._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_time._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_time._5</code>.
     */
    ...
    public GinExtractQueryTime() {
        super("gin_extract_query_time", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
