...
public class GinExtractValueInt4 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1864332957;

    /**
     * The parameter <code>public.gin_extract_value_int4.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_int4._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>public.gin_extract_value_int4._2</code>.
     */
    ...
    public GinExtractValueInt4() {
        super("gin_extract_value_int4", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
