...
public class _IntbigOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1288997388;

    /**
     * The parameter <code>public._intbig_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public._intbig_out._1</code>.
     */
     ...
     */
    public _IntbigOut() {
        super("_intbig_out", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
