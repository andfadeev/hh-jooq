...
public class GbtInt2Distance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1701065946;
    ...
    /**
     * The parameter <code>public.gbt_int2_distance._1</code>.
     */
    ...
    public GbtInt2Distance() {
        super("gbt_int2_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
