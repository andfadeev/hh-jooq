...
public class GbtOidUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1627884930;

    /**
     * The parameter <code>public.gbt_oid_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtOidUnion() {
        super("gbt_oid_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
