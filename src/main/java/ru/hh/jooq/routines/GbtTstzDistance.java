...
public class GbtTstzDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1525023433;
    ...
    /**
     * The parameter <code>public.gbt_tstz_distance._1</code>.
     */
    ...
    public GbtTstzDistance() {
        super("gbt_tstz_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
