...
public class GbtInt2Union extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1101986182;

    /**
     * The parameter <code>public.gbt_int2_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt2Union() {
        super("gbt_int2_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
