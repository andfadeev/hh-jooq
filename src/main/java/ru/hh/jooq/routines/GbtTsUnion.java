...
public class GbtTsUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -37164494;

    /**
     * The parameter <code>public.gbt_ts_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtTsUnion() {
        super("gbt_ts_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
