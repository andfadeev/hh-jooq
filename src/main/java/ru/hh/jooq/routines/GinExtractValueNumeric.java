...
public class GinExtractValueNumeric extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1070399566;

    /**
     * The parameter <code>public.gin_extract_value_numeric.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_numeric._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>public.gin_extract_value_numeric._2</code>.
     */
    ...
    public GinExtractValueNumeric() {
        super("gin_extract_value_numeric", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
