...
public class GinExtractValueOid extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1708647726;

    /**
     * The parameter <code>public.gin_extract_value_oid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_oid._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>public.gin_extract_value_oid._2</code>.
     */
    ...
    public GinExtractValueOid() {
        super("gin_extract_value_oid", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
