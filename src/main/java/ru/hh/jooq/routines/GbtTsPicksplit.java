...
public class GbtTsPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1331465620;

    /**
     * The parameter <code>public.gbt_ts_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_ts_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_ts_picksplit._2</code>.
     */
    ...
    public GbtTsPicksplit() {
        super("gbt_ts_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
