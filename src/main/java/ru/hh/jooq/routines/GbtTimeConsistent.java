...
public class GbtTimeConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 595607078;
    ...
    /**
     * The parameter <code>public.gbt_time_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_time_consistent._5</code>.
     */
    ...
    public GbtTimeConsistent() {
        super("gbt_time_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
