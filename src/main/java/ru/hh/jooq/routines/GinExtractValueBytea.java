...
public class GinExtractValueBytea extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1287521338;

    /**
     * The parameter <code>public.gin_extract_value_bytea.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_bytea._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gin_extract_value_bytea._2</code>.
     */
    ...
    public GinExtractValueBytea() {
        super("gin_extract_value_bytea", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
