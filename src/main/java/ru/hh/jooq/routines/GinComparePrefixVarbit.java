...
public class GinComparePrefixVarbit extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 77048481;

    /**
     * The parameter <code>public.gin_compare_prefix_varbit.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.gin_compare_prefix_varbit._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.VARCHAR, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_varbit._2</code>.
     */
    public static final Parameter<String> _2 = createParameter("_2", org.jooq.impl.SQLDataType.VARCHAR, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_varbit._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_varbit._4</code>.
     */
    ...
    public GinComparePrefixVarbit() {
        super("gin_compare_prefix_varbit", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
