...
public class GbtTextUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 414322830;

    /**
     * The parameter <code>public.gbt_text_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtTextUnion() {
        super("gbt_text_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
