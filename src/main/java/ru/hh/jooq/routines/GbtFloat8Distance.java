...
public class GbtFloat8Distance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 1504540704;
    ...
    /**
     * The parameter <code>public.gbt_float8_distance._1</code>.
     */
    ...
    public GbtFloat8Distance() {
        super("gbt_float8_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
