...
public class GinExtractValueInet extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 827063421;

    /**
     * The parameter <code>public.gin_extract_value_inet.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_inet._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_inet._2</code>.
     */
    ...
    public GinExtractValueInet() {
        super("gin_extract_value_inet", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
