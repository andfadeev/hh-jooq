...
public class GinExtractQueryText extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1909678327;

    /**
     * The parameter <code>public.gin_extract_query_text.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_text._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.gin_extract_query_text._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_text._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_text._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_text._5</code>.
     */
    ...
    public GinExtractQueryText() {
        super("gin_extract_query_text", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
