...
public class IntervalDist extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -708225568;
     ...
     */
    public IntervalDist() {
        super("interval_dist", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
