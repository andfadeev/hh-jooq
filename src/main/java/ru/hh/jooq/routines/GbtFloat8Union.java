...
public class GbtFloat8Union extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -37856980;

    /**
     * The parameter <code>public.gbt_float8_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float8_union._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gbt_float8_union._2</code>.
     */
    ...
    public GbtFloat8Union() {
        super("gbt_float8_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
