...
public class Querytree extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1366359059;

    /**
     * The parameter <code>public.querytree.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.querytree._1</code>.
     */
     ...
     */
    public Querytree() {
        super("querytree", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
