...
public class GbtTsConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 411398170;
    ...
    /**
     * The parameter <code>public.gbt_ts_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_ts_consistent._5</code>.
     */
    ...
    public GbtTsConsistent() {
        super("gbt_ts_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
