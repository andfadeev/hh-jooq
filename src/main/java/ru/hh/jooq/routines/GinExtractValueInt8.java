...
public class GinExtractValueInt8 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -22051156;

    /**
     * The parameter <code>public.gin_extract_value_int8.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_int8._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>public.gin_extract_value_int8._2</code>.
     */
    ...
    public GinExtractValueInt8() {
        super("gin_extract_value_int8", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
