...
public class GbtTextConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -361974874;
    ...
    /**
     * The parameter <code>public.gbt_text_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_text_consistent._5</code>.
     */
    ...
    public GbtTextConsistent() {
        super("gbt_text_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
