...
public class GinExtractQueryBit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 860805207;

    /**
     * The parameter <code>public.gin_extract_query_bit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bit._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_query_bit._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bit._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_bit._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_bit._5</code>.
     */
    ...
    public GinExtractQueryBit() {
        super("gin_extract_query_bit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
