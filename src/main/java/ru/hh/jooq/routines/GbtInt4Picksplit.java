...
public class GbtInt4Picksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1919487904;

    /**
     * The parameter <code>public.gbt_int4_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_int4_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_int4_picksplit._2</code>.
     */
    ...
    public GbtInt4Picksplit() {
        super("gbt_int4_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
