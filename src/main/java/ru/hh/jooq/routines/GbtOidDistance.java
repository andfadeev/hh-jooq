...
public class GbtOidDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 597885105;
    ...
    /**
     * The parameter <code>public.gbt_oid_distance._1</code>.
     */
    ...
    public GbtOidDistance() {
        super("gbt_oid_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
