...
public class GinExtractValueMoney extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 262724788;

    /**
     * The parameter <code>public.gin_extract_value_money.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_money._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>public.gin_extract_value_money._2</code>.
     */
    ...
    public GinExtractValueMoney() {
        super("gin_extract_value_money", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
