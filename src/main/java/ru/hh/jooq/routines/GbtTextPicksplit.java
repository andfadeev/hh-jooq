...
public class GbtTextPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1093220752;

    /**
     * The parameter <code>public.gbt_text_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_text_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_text_picksplit._2</code>.
     */
    ...
    public GbtTextPicksplit() {
        super("gbt_text_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
