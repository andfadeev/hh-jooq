...
public class GbtDateConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1262591098;
    ...
    /**
     * The parameter <code>public.gbt_date_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_date_consistent._5</code>.
     */
    ...
    public GbtDateConsistent() {
        super("gbt_date_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
