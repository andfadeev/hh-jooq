...
public class GinExtractValueTimestamp extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -983605682;

    /**
     * The parameter <code>public.gin_extract_value_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_timestamp._1</code>.
     */
    public static final Parameter<LocalDateTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATETIME, false, true);

    /**
     * The parameter <code>public.gin_extract_value_timestamp._2</code>.
     */
    ...
    public GinExtractValueTimestamp() {
        super("gin_extract_value_timestamp", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
