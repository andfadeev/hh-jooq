...
public class IntsetSubtract extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = -2012166332;

    /**
     * The parameter <code>public.intset_subtract.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.intset_subtract._1</code>.
     */
    ...
    /**
     * The parameter <code>public.intset_subtract._2</code>.
     */
     ...
     */
    public IntsetSubtract() {
        super("intset_subtract", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
