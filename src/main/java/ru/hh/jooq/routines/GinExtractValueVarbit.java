...
public class GinExtractValueVarbit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1465733377;

    /**
     * The parameter <code>public.gin_extract_value_varbit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_varbit._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.VARCHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_value_varbit._2</code>.
     */
    ...
    public GinExtractValueVarbit() {
        super("gin_extract_value_varbit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
