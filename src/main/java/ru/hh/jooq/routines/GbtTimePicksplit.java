...
public class GbtTimePicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1578353072;

    /**
     * The parameter <code>public.gbt_time_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_time_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_time_picksplit._2</code>.
     */
    ...
    public GbtTimePicksplit() {
        super("gbt_time_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
