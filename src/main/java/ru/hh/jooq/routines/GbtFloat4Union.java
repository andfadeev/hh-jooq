...
public class GbtFloat4Union extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1668679644;

    /**
     * The parameter <code>public.gbt_float4_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float4_union._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gbt_float4_union._2</code>.
     */
    ...
    public GbtFloat4Union() {
        super("gbt_float4_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
