...
public class GinExtractQueryTimestamptz extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1694567858;

    /**
     * The parameter <code>public.gin_extract_query_timestamptz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamptz._1</code>.
     */
    public static final Parameter<LocalDateTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATETIME, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timestamptz._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamptz._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timestamptz._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timestamptz._5</code>.
     */
    ...
    public GinExtractQueryTimestamptz() {
        super("gin_extract_query_timestamptz", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
