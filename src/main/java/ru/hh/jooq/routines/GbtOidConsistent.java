...
public class GbtOidConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -619062235;
    ...
    /**
     * The parameter <code>public.gbt_oid_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_oid_consistent._5</code>.
     */
    ...
    public GbtOidConsistent() {
        super("gbt_oid_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
