...
public class GinExtractQueryMoney extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -813801758;

    /**
     * The parameter <code>public.gin_extract_query_money.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_money._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>public.gin_extract_query_money._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_money._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_money._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_money._5</code>.
     */
    ...
    public GinExtractQueryMoney() {
        super("gin_extract_query_money", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
