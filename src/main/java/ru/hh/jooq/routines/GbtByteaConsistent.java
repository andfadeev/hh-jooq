...
public class GbtByteaConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -79251276;
    ...
    /**
     * The parameter <code>public.gbt_bytea_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bytea_consistent._5</code>.
     */
    ...
    public GbtByteaConsistent() {
        super("gbt_bytea_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
