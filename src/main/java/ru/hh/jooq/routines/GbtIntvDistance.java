...
public class GbtIntvDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 803532911;
    ...
    /**
     * The parameter <code>public.gbt_intv_distance._1</code>.
     */
    ...
    public GbtIntvDistance() {
        super("gbt_intv_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
