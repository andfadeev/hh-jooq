...
public class GIntbigUnion extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = -2142941826;

    /**
     * The parameter <code>public.g_intbig_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.g_intbig_union._1</code>.
     */
    ...
    /**
     * The parameter <code>public.g_intbig_union._2</code>.
     */
     ...
     */
    public GIntbigUnion() {
        super("g_intbig_union", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
