...
public class GbtTimeDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1101868747;
    ...
    /**
     * The parameter <code>public.gbt_time_distance._1</code>.
     */
    ...
    public GbtTimeDistance() {
        super("gbt_time_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
