...
public class GbtIntvPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -47052516;

    /**
     * The parameter <code>public.gbt_intv_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_intv_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_intv_picksplit._2</code>.
     */
    ...
    public GbtIntvPicksplit() {
        super("gbt_intv_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
