...
public class Subarray1 extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = 1865479036;

    /**
     * The parameter <code>public.subarray.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.subarray._1</code>.
     */
     ...
     */
    public Subarray1() {
        super("subarray", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
