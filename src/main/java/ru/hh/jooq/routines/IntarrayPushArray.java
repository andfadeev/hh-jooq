...
public class IntarrayPushArray extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = -559372932;

    /**
     * The parameter <code>public.intarray_push_array.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.intarray_push_array._1</code>.
     */
    ...
    /**
     * The parameter <code>public.intarray_push_array._2</code>.
     */
     ...
     */
    public IntarrayPushArray() {
        super("intarray_push_array", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
