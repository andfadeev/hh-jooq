...
public class GbtOidPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -2047835720;

    /**
     * The parameter <code>public.gbt_oid_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_oid_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_oid_picksplit._2</code>.
     */
    ...
    public GbtOidPicksplit() {
        super("gbt_oid_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
