...
public class GinExtractValueTimestamptz extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 495478350;

    /**
     * The parameter <code>public.gin_extract_value_timestamptz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_timestamptz._1</code>.
     */
    public static final Parameter<LocalDateTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATETIME, false, true);

    /**
     * The parameter <code>public.gin_extract_value_timestamptz._2</code>.
     */
    ...
    public GinExtractValueTimestamptz() {
        super("gin_extract_value_timestamptz", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
