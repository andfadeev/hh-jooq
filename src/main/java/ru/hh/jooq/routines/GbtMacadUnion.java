...
public class GbtMacadUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1027626274;

    /**
     * The parameter <code>public.gbt_macad_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_macad_union._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gbt_macad_union._2</code>.
     */
    ...
    public GbtMacadUnion() {
        super("gbt_macad_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
