...
public class GetRawPage2 extends AbstractRoutine<byte[]> {
     ...
     */
    public GetRawPage2() {
        super("get_raw_page", Public.PUBLIC, org.jooq.impl.SQLDataType.BLOB);
