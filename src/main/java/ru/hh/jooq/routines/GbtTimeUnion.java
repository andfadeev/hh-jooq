...
public class GbtTimeUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1662839758;

    /**
     * The parameter <code>public.gbt_time_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtTimeUnion() {
        super("gbt_time_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
