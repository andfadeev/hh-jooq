...
public class IntarrayPushElem extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = -525033018;

    /**
     * The parameter <code>public.intarray_push_elem.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.intarray_push_elem._1</code>.
     */
    ...
    /**
     * The parameter <code>public.intarray_push_elem._2</code>.
     */
     ...
     */
    public IntarrayPushElem() {
        super("intarray_push_elem", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
