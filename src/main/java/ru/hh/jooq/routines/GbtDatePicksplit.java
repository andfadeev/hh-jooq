...
public class GbtDatePicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1666104946;

    /**
     * The parameter <code>public.gbt_date_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_date_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_date_picksplit._2</code>.
     */
    ...
    public GbtDatePicksplit() {
        super("gbt_date_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
