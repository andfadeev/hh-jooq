...
public class GinExtractQueryVarbit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -727143257;

    /**
     * The parameter <code>public.gin_extract_query_varbit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_varbit._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.VARCHAR, false, true);

    /**
     * The parameter <code>public.gin_extract_query_varbit._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_varbit._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_varbit._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_varbit._5</code>.
     */
    ...
    public GinExtractQueryVarbit() {
        super("gin_extract_query_varbit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
