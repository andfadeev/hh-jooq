...
public class GbtCashPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 562822020;

    /**
     * The parameter <code>public.gbt_cash_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_cash_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_cash_picksplit._2</code>.
     */
    ...
    public GbtCashPicksplit() {
        super("gbt_cash_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
