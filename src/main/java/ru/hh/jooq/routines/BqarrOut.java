...
public class BqarrOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2018832534;

    /**
     * The parameter <code>public.bqarr_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.bqarr_out._1</code>.
     */
     ...
     */
    public BqarrOut() {
        super("bqarr_out", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
