...
public class GinExtractValueInt2 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1730141693;

    /**
     * The parameter <code>public.gin_extract_value_int2.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_int2._1</code>.
     */
    public static final Parameter<Short> _1 = createParameter("_1", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_value_int2._2</code>.
     */
    ...
    public GinExtractValueInt2() {
        super("gin_extract_value_int2", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
