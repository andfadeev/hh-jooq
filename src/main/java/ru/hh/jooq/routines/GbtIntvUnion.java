...
public class GbtIntvUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1537752834;

    /**
     * The parameter <code>public.gbt_intv_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtIntvUnion() {
        super("gbt_intv_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
