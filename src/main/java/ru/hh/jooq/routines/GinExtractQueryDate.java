...
public class GinExtractQueryDate extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 609235617;

    /**
     * The parameter <code>public.gin_extract_query_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_date._1</code>.
     */
    public static final Parameter<LocalDate> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATE, false, true);

    /**
     * The parameter <code>public.gin_extract_query_date._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_date._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_date._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_date._5</code>.
     */
    ...
    public GinExtractQueryDate() {
        super("gin_extract_query_date", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
