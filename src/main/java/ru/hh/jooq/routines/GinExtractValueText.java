...
public class GinExtractValueText extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 623047730;

    /**
     * The parameter <code>public.gin_extract_value_text.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_text._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.gin_extract_value_text._2</code>.
     */
    ...
    public GinExtractValueText() {
        super("gin_extract_value_text", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
