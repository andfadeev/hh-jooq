...
public class GbtNumericUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1389733334;

    /**
     * The parameter <code>public.gbt_numeric_union.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_numeric_union._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gbt_numeric_union._2</code>.
     */
    ...
    public GbtNumericUnion() {
        super("gbt_numeric_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
