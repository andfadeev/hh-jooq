...
public class GbtInetUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1369173668;

    /**
     * The parameter <code>public.gbt_inet_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInetUnion() {
        super("gbt_inet_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
