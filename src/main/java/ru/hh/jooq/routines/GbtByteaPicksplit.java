...
public class GbtByteaPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -109892012;

    /**
     * The parameter <code>public.gbt_bytea_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bytea_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bytea_picksplit._2</code>.
     */
    ...
    public GbtByteaPicksplit() {
        super("gbt_bytea_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
