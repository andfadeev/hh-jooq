...
public class GbtInt8Union extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -742745466;

    /**
     * The parameter <code>public.gbt_int8_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt8Union() {
        super("gbt_int8_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
