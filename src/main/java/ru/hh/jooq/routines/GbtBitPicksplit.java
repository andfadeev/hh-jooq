...
public class GbtBitPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -859407196;

    /**
     * The parameter <code>public.gbt_bit_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bit_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bit_picksplit._2</code>.
     */
    ...
    public GbtBitPicksplit() {
        super("gbt_bit_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
