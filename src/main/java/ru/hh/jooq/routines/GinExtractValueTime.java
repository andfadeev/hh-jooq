...
public class GinExtractValueTime extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -371283280;

    /**
     * The parameter <code>public.gin_extract_value_time.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_value_time._1</code>.
     */
    public static final Parameter<LocalTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALTIME, false, true);

    /**
     * The parameter <code>public.gin_extract_value_time._2</code>.
     */
    ...
    public GinExtractValueTime() {
        super("gin_extract_value_time", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
