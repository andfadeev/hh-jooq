...
public class GbtFloat4Distance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -209291994;
    ...
    /**
     * The parameter <code>public.gbt_float4_distance._1</code>.
     */
    ...
    public GbtFloat4Distance() {
        super("gbt_float4_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
