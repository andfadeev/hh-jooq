...
public class GinComparePrefixBytea extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 1780234325;

    /**
     * The parameter <code>public.gin_compare_prefix_bytea.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.gin_compare_prefix_bytea._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_bytea._2</code>.
     */
    public static final Parameter<byte[]> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_bytea._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_compare_prefix_bytea._4</code>.
     */
    ...
    public GinComparePrefixBytea() {
        super("gin_compare_prefix_bytea", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
