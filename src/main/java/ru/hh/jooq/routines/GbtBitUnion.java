...
public class GbtBitUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -2025108266;

    /**
     * The parameter <code>public.gbt_bit_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtBitUnion() {
        super("gbt_bit_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
