...
public class GinExtractQueryNumeric extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1278419979;

    /**
     * The parameter <code>public.gin_extract_query_numeric.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_numeric._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>public.gin_extract_query_numeric._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_numeric._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_numeric._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_numeric._5</code>.
     */
    ...
    public GinExtractQueryNumeric() {
        super("gin_extract_query_numeric", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
