...
public class PgGrant extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1671082542;

    /**
     * The parameter <code>public.pg_grant.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.pg_grant._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.pg_grant._2</code>.
     */
    public static final Parameter<String> _2 = createParameter("_2", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.pg_grant._3</code>.
     */
    public static final Parameter<String> _3 = createParameter("_3", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.pg_grant._4</code>.
     */
     ...
     */
    public PgGrant() {
        super("pg_grant", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
