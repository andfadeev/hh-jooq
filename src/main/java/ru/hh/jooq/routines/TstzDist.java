...
public class TstzDist extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2013668965;
     ...
     */
    public TstzDist() {
        super("tstz_dist", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
