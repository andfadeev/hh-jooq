...
public class GbtBitConsistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -459509620;
    ...
    /**
     * The parameter <code>public.gbt_bit_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_bit_consistent._5</code>.
     */
    ...
    public GbtBitConsistent() {
        super("gbt_bit_consistent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
