...
public class SortDesc extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = 2041545552;

    /**
     * The parameter <code>public.sort_desc.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.sort_desc._1</code>.
     */
     ...
     */
    public SortDesc() {
        super("sort_desc", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
