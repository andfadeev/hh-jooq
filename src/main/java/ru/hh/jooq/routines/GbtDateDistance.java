...
public class GbtDateDistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -728488426;
    ...
    /**
     * The parameter <code>public.gbt_date_distance._1</code>.
     */
    ...
    public GbtDateDistance() {
        super("gbt_date_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
