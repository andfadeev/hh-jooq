...
public class GbtNumericPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 925835428;

    /**
     * The parameter <code>public.gbt_numeric_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_numeric_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_numeric_picksplit._2</code>.
     */
    ...
    public GbtNumericPicksplit() {
        super("gbt_numeric_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
