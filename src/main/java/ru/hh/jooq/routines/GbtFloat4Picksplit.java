...
public class GbtFloat4Picksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1368290938;

    /**
     * The parameter <code>public.gbt_float4_picksplit.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float4_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>public.gbt_float4_picksplit._2</code>.
     */
    ...
    public GbtFloat4Picksplit() {
        super("gbt_float4_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
