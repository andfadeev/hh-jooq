...
public class CashDist extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1960530079;

    /**
     * The parameter <code>public.cash_dist.RETURN_VALUE</code>.
     */
     ...
     */
    public CashDist() {
        super("cash_dist", Public.PUBLIC, org.jooq.impl.SQLDataType.NUMERIC);
