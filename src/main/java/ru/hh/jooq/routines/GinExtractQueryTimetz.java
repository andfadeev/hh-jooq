...
public class GinExtractQueryTimetz extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 784179861;

    /**
     * The parameter <code>public.gin_extract_query_timetz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timetz._1</code>.
     */
    public static final Parameter<LocalTime> _1 = createParameter("_1", org.jooq.impl.SQLDataType.LOCALTIME, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timetz._2</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timetz._3</code>.
     */
    public static final Parameter<Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>public.gin_extract_query_timetz._4</code>.
     */
    ...
    /**
     * The parameter <code>public.gin_extract_query_timetz._5</code>.
     */
    ...
    public GinExtractQueryTimetz() {
        super("gin_extract_query_timetz", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
