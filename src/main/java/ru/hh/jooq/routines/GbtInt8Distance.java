...
public class GbtInt8Distance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 566572285;
    ...
    /**
     * The parameter <code>public.gbt_int8_distance._1</code>.
     */
    ...
    public GbtInt8Distance() {
        super("gbt_int8_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
