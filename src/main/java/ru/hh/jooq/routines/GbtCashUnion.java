...
public class GbtCashUnion extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1950355610;

    /**
     * The parameter <code>public.gbt_cash_union.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtCashUnion() {
        super("gbt_cash_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
