...
public class IntsetUnionElem extends AbstractRoutine<Integer[]> {

    private static final long serialVersionUID = 1025833626;

    /**
     * The parameter <code>public.intset_union_elem.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.intset_union_elem._1</code>.
     */
    ...
    /**
     * The parameter <code>public.intset_union_elem._2</code>.
     */
     ...
     */
    public IntsetUnionElem() {
        super("intset_union_elem", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER.getArrayDataType());
