...
public class GbtInt4Distance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 42445610;
    ...
    /**
     * The parameter <code>public.gbt_int4_distance._1</code>.
     */
    ...
    public GbtInt4Distance() {
        super("gbt_int4_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
